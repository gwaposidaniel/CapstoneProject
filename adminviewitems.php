...
?>   
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="admindashboard/adminhome.php">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="admindashboard/adminhome.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/BizLand/additems.php">
...
<section class="vh-100" style="background-color: #eee;">
  <div class="container h-100">
    ...
    <div class="navigation" style="margin-bottom: 20px; font-size: 20px; ">
        ...
        <tr>
            <td><img src="../uploads/<?php echo $row['Picture']?>" 
            width="150px" height="100px"></td>
            <td><?php echo $row['ItemName']?></td>
            <td><?php echo $row['Description']?></td>
            <td><button type="btn btn-danger">Delete</button> </td>
            <td><button type="btn btn-success">Update</button></td>
        </tr>
