<?php
 ...
 if(empty($_SESSION['email'])){
    ...
    $getadmin = mysqli_query($conn, "SELECT * FROM users WHERE email ='$e'");
...
<body id="page-top">
    ...
    <div id="wrapper" class="">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion  bg-gradient-success" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="userhome.php">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                        $get_claimed = mysqli_query($conn,"SELECT * FROM items WHERE posted_by = '$e'");
