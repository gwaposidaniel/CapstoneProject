...
<body id="page-top">
    ...
    <div id="wrapper" class="">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion  bg-gradient-success" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="userupload.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="userrecord.php">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="process.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="user_email" value="<?php echo $e; ?>">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="/Bizland/index.php">Logout</a>
                </div>
            </div>
        </div>
    </div>
